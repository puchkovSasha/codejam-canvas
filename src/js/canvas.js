...
var colors = [ ["#00BCD4", "#FFEB3B","#FFEB3B","#00BCD4"],
                ...
                for(var q = 0; q < colors.length; q++){
                    for(var w = 0; w < colors[q].length; w++){
                        ctx.fillStyle=colors[q][w];
                        ctx.fillRect(x*w,y*q,canvas.width/4,canvas.height/4);
...
btn32x32.addEventListener('click', ()=>{
    ...
    let x = canvas.width/32;
    let y = canvas.width/32;

    for(var q = 0; q < data3.length; q++){
        for(var w = 0; w < data3[q].length; w++){

            for (let r = 0; r < data3[w].length; r++) {
                
                
                ctx.fillStyle=`rgba(${data3[q][w][r]},${data3[q][w][r+1]},${data3[q][w][r+2]},${data3[q][w][r+3]})`;
                
                
                ctx.fillRect(x*w,y*q,canvas.width/32,canvas.height/32);
            }
